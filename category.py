...
class categoryclass:
    def __init__(self,root):
        ...
        #===== TITAL ==========
        lbl_tital=Label(self.root,text="Manage Product Category",font=("goudy old style",30,"bold"),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)

        lbl_name=Label(self.root,text="Manage Product Category",font=("goudy old style",20),bg="white").place(x=50,y=100)
        ...
        btn_delete=Button(self.root,text="Delete",command=self.Delete,font=("goudy old style",15),bg="red",fg="white",cursor="hand2").place(x=512,y=170,width=150,height=35)

        #====== Category Details ===========

        cat_frame=Frame(self.root,bd=3,relief=RIDGE,bg="blue")
        cat_frame.place(x=700,y=100,width=380,height=100) # fram Size
        ...
        self.category_table.heading("name",text="Supplier Name")
        ...
        self.im1=self.im1.resize((500,200),Image.BILINEAR)
        ...
        self.im2=self.im2.resize((500,200),Image.BILINEAR)
        ...
        try:
            if self.var_cat_id.get()=="":
               messagebox.showerror("Error","please select Category from the list",parent=self.root)
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Error, please try agine",parent=self.root)
                else:
